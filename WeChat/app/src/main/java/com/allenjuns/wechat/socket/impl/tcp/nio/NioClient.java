package com.allenjuns.wechat.socket.impl.tcp.nio;


import com.allenjuns.wechat.socket.GClient;
...
public final class NioClient extends BaseClient {
    ...
    public NioClient(BaseMessageProcessor mMessageProcessor, IConnectListener mConnectListener, IReceiveData iReceiveData) {
