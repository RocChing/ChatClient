...
public class WebViewActivity$$ViewBinder<T extends com.allenjuns.wechat.app.module.system.WebViewActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624131, "field 'mWebView'");
    target.mWebView = finder.castView(view, 2131624131, "field 'mWebView'");
  }
